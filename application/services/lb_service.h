...
#define BT_UUID_LBS_SAMPLING_INTERVAL_VAL BT_UUID_128_ENCODE(0x00001527, 0x1212, 0xefde, 0x1523, 0x785feabcd123)
...
#define BT_UUID_LBS_SAMPLING_INTERVAL BT_UUID_DECLARE_128(BT_UUID_LBS_SAMPLING_INTERVAL_VAL)
